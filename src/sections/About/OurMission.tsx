...
export const OurMission = () => {
  ...
  return (
    <section className="bg-ourMisionBgColor pb-[50px] md:pb-0">
      <div className="mx-auto md:flex lg:max-h-[600px]">
        <img
        ...
        />
        <motion.div
          className="mx-auto flex max-w-[390px] flex-col justify-center px-[15px] transition md:w-1/2 md:max-w-[768px] md:p-[30px] lg:max-w-none lg:py-0 lg:pl-[70px] lg:pr-[150px]"
          {...ourMissionProps}
        >
